...
# On github: `topepo/2025_NY_RUG`  {background-color="#B25D91FF"}
...
Emil Hvitfeldt has worked very hard to make sure that we can consume/use sparse data structures in tidymodels. 
